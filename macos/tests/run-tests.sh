...
/usr/bin/grep -q 'data-feature="game-source"' "$ROOT/assets/xiaolongnv-renderer-inject.js"
/usr/bin/grep -q 'buttons.length === 3' "$ROOT/assets/xiaolongnv-renderer-inject.js"
