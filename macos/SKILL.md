...
- `assets/xiaolongnv-skin.css`: live native interface styling shared with the Windows design.
- `assets/xiaolongnv-renderer-inject.js`: idempotent DOM integration, connector geometry, and cleanup.
- `assets/dream-reference.png`: bundled default background.
- `assets/codex-logo.png`: bundled logo mask.
